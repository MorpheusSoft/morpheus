            ...
            <li key={item.href}>
              ...
              >
                ...
                <i className={`${item.icon} text-[18px] transition-transform duration-300 z-30 shrink-0 ${
                  isActive ? 'text-indigo-400 scale-110 drop-shadow-sm' : 'text-slate-500 group-hover:text-slate-400 group-hover:scale-110'
                }`}></i>
  ...
  return (
    ...
    >
      ...
      <div className={`border-t border-[#1e293b] bg-[#0f172a] transition-all duration-300 ${
        ...
        >
          <div className="w-[36px] h-[36px] rounded-full bg-indigo-900 border border-indigo-500/50 flex items-center justify-center text-indigo-200 font-bold text-[14px] shadow-inner shadow-indigo-500/20 shrink-0">
            {userInitials}
          </div>

...
export default function StoreSyncDashboardPage() {
  ...
  const [updateTargetVersion, setUpdateTargetVersion] = useState("2.4.4-neo");
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap items-center gap-2 mt-0.5">
                        ...
                        {selectedFacility.has_update_available ? (
                          <button
                            onClick={() => {
                              setUpdateTargetVersion(selectedFacility.latest_available_version || "2.4.4-neo");
                          ...
                          >
                            ...
                            Actualizar a v{selectedFacility.latest_available_version || "2.4.4-neo"}
                          </button>
                        ) : (
                        ...
                        <div>
                          ...
                          <div className="flex flex-wrap items-center gap-2.5 mt-2.5">
                            ...
                            <div className={`flex items-center gap-1.5 px-2.5 py-1 rounded-lg text-xs border shadow-2xs ${
                              ...
                              <span className="font-mono">v{selectedFacility.latest_available_version || "2.4.4-neo"}</span>
                            </div>
                            {selectedFacility.has_update_available && (
                      ...
                      >
                        {executingCmd === 'UPDATE_SOFTWARE' ? (
                          ...
                          <>
                            ...
                            <span>🚀 Actualizar a v{selectedFacility.latest_available_version || "2.4.4-neo"}</span>
                          </>
                        ) : (
                          <>
                            <i className="pi pi-check text-sm"></i>
                            <span>Reinstalar / Forzar v{selectedFacility.latest_available_version || "2.4.4-neo"}</span>
                          </>
                        )}
                      </button>
                    </div>

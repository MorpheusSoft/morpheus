  ...
  return (
    <header className="h-16 bg-white/70 backdrop-blur-xl border-b border-gray-200/50 flex items-center justify-between px-4 sm:px-6 sticky top-0 z-10 shadow-sm transition-all duration-300">
      ...
      <div className="flex items-center gap-3">
        ...
        <h2 className="text-base sm:text-lg font-bold text-slate-800 tracking-tight hidden sm:block">Control de Inventario</h2>
      </div>
      ...
      <div className="flex items-center gap-3 ml-auto">
        <AppSwitcher />
        <button 
          className="relative w-10 h-10 flex items-center justify-center text-gray-500 hover:bg-cyan-50 hover:text-cyan-600 rounded-full transition-all duration-200 active:scale-95 cursor-pointer"
        ...
        <button 
          className="w-10 h-10 flex items-center justify-center text-gray-500 hover:bg-cyan-50 hover:text-cyan-600 rounded-full transition-all duration-200 active:scale-95 cursor-pointer"
          title="Configuración"
          type="button"
        >

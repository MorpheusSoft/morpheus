    ...
    <div className="p-2 sm:p-6 bg-slate-50 min-h-full">
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-slate-500 text-sm mt-1">Nuevo Proveedor • Registro Centralizado</p>
        </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
        <TabView className="modern-tabs p-4 sm:p-6">
          ...
          {/* TAB 4: Catálogo Bancario */}
          <TabPanel header="4. Cuentas Bancarias" leftIcon="pi pi-credit-card mr-2">
             <div className="pt-4">
          ...
          {/* TAB 5: Políticas de Cambio y Devolución */}
          <TabPanel header="5. Políticas de Cambio" leftIcon="pi pi-replay mr-2">
